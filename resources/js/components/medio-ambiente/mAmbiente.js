...
class Ambiente extends React.Component{
    ...
    render(){
        return(
            ...
            <br /> <br />
            <img src="images/seq.jpeg" className="rounded mx-auto d-block img-fluid" alt="sequia" />
            <br />
            ...
            <div className="text-center">
              <img src="images/nature.jpeg" className="rounded mx-auto d-block img-fluid" alt="hojas" />
            </div>
            <br />
            En <img className="icoEnano" src="images/logo.svg" alt="logo2" id="icoEnano" /> creemos que además de frenar esta contaminación podemos fomentar a los pequeños sastres locales para dar
